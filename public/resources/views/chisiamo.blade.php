...
@section('left_navbar')
              <li class="nav-item">
                <a class="nav-link current" aria-current="page" href="{{route('chisiamo')}}" >Home</a>
              </li>
              <li class="nav-item">
...
@section('corpo1')
        <div class="row justify-content-md-center">
          <div class="col-lg-6">
              <div id="carouselExampleCaptions" class="carousel slide" data-bs-ride="carousel" style="margin-bottom: 0.75cm; margin-top: 0.25cm;">
              
                <div class="carousel-inner">
                  <div class="carousel-item active" data-bs-interval="3500">
                    <img src="img/titolo2.png" class="d-block w-100" alt="titolo">
                  </div>
                  <div class="carousel-item" data-bs-interval="2700">
                    <img src="img/panoramica.JPG" class="d-block w-100" alt="panoramica">
                  </div>
                  <div class="carousel-item" data-bs-interval="2000">
                    <img src="img/territorio.JPG" class="d-block w-100" alt="territorio">
                  <div class="carousel-caption d-none d-md-block">
                    <a href="{{route('territorio')}}" class="btn btn-light btn-prodotti btn-sm" style="font-weight: bold;">Il Territorio</a>
                  </div>
                  </div>
                
                <div class="carousel-item" data-bs-interval="2200">
                  <img src="img/coltivazioni.JPG" class="d-block w-100" alt="coltivazioni">
                  <div class="carousel-caption d-none d-md-block">
                    <a href="{{route('coltivazioni')}}" class="btn btn-light btn-prodotti btn-sm" style="font-weight: bold; margin-top: 1cm;">Coltivazioni</a>
                  </div>
                </div>

                <div class="carousel-item" data-bs-interval="2200">
                  <img src="img/animali.JPG" class="d-block w-100" alt="allevamenti">
                  <div class="carousel-caption d-none d-md-block">
                    <a href="{{route('animali')}}" class="btn btn-light btn-prodotti btn-sm" style="font-weight: bold;">Allevamenti</a>
                </div>
                </div>

                <div class="carousel-item" data-bs-interval="2200">
                  <img src="img/prodotti.jpg" class="d-block w-100" alt="prodotti">
                  <div class="carousel-caption d-none d-md-block">
                    <a href="{{route('prodotti')}}" class="btn btn-light btn-prodotti btn-sm" style="font-weight: bold;">I Nostri Prodotti</a>
                </div>
                </div>

                <div class="carousel-item" data-bs-interval="2000">
                  <img src="img/fototrattori3.JPG" class="d-block w-100" alt="contatti">
                  <div class="carousel-caption d-none d-md-block">
                    <a href="{{route('contatti')}}" class="btn btn-light btn-prodotti btn-sm" style="font-weight: bold;">Contatti</a>
                </div>
                </div>
...
@section('corpo2')
       <div class="row justify-content-md-center">
       <div class="col-sm-6 align-self-center" style="margin-top: 0.5cm">
        <img src="img/eccellenza.png" class="d-block w-100" alt="eccellenza">
       </div>
       </div>

        <div class="row justify-content-md-center" style="margin-top: 1cm">
          <div class="col-sm-8">
              <p>La cascina Pagani ha ben 100 anni, risale infatti agli anni '20.
                L'azienda agricola è stata però fondata in epoca successiva dal bisnonno, 
                Luigi Pagani, che alternava il lavoro nei campi alla sua grande passione: la musica. 
                Era infatti un direttore d'orchestra.</p>

                <p>Partendo da una piccola realtà di coltivazione e allevamento, più per scopi di 
                  auto sostentamento che di attività lavorativa, nel corso degli anni - con determinazione, 
                  passione e amore per il proprio lavoro - la famiglia Pagani ha sviluppato una realtà
                   estesa a più settori, con uno sguardo sempre rivolto al futuro e all'ambiente.</p>

                   <p>Attualmente l'azienda è condotta dai fratelli Luigi e Piero Pagani e da Marco Pagani, 
                    figlio di Luigi.
                    Il motto di famiglia è, ancora oggi, “Agricoltori si nasce”, perché solo chi ama la 
                    propria terra e le proprie origini, chi vive da sempre questa realtà da vicino, può 
                    davvero capire e portare avanti questo lavoro da ben 4 generazioni, con la stessa grande 
                    passione e la stessa voglia di crescere dei propri avi.            
                    </p>
            </div>
            </div>
      
            <div class="row justify-content-md-center" style="margin-top: 0.75cm;">
              <div class="col-sm-4 me-md-2">
                <img src="img/IMG_5077.jpg" class="img-fluid img-thumbnail" alt="panoramica">
              </div>
              <div class="col-sm-4">
                <img src="img/fotochisiamo.JPG" class="img-fluid img-thumbnail" alt="panoramica">
              </div>
            </div>
