...
@section('left_navbar')
                  ...
                  <li class="nav-item">
                    <a class="nav-link current" aria-current="page" href="{{route('animali')}}">Allevamenti</a>
                  </li>
...
@section('corpo1')
          <div class="row justify-content-md-center">
            <div class="col-sm-3 ">
              <img src="img/animali3.jpg" class="img-fluid img-thumbnail" alt="panoramica">
            </div>

            
            <div class="col-sm-4" style="margin-top: 0.5cm">
              <p style="text-align: center"> Nella nostra cascina da sempre si allevano bovini e suini, le cui carni vengono trasformate 
              all'interno del nostro laboratorio ed utilizzate esclusivamente per la produzione dei nostri 
              insaccati. I bovini attuali, 5/6 capi, vengono alimentati con foraggi e cereali prodotti 
              dall'azienda. Una volta raggiunto il peso ideale, vengono macellati esternamente da una 
              macelleria della zona, che collabora storicamente con la nostra famiglia, e riportati in 
              azienda per la lavorazione.
              </p>
            </div>

            <div class="col-sm-3 ">
              <img src="img/maiale.jpg" class="img-fluid img-thumbnail" alt="panoramica">
            </div>

          </div>

          <div class="row justify-content-md-center" style="margin-top: 1cm;">
            <div class="col-sm-7" style="margin-top: 0.25cm;">
              <p style="text-align: center"> I suini, 30 capi, vengono anch'essi alimentati e cresciuti 
                esclusivamente con i cereali da noi coltivati e sono macellati direttamente all'interno 
                dell'azienda, in appositi spazi adibiti appunto alla macellazione.
                L'azienda Soleluna ha sempre però seguito le richieste del mercato, iniziando con 
                un allevamento di galline ovaiole (primi due capannoni), ampliandosi poi negli anni 80 con 
                un allevamento di circa 100 bovini (tori) in soccida, fino all'inizio degli anni 2000.
                A partire dagli anni successivi, con una richiesta sempre minore di carni rosse, l'azienda 
                ha convertito la maggior parte di questa attività nell'allevamento in soccida di polli da 
                carne, attività che negli anni è cresciuta e che ha portato alla costruzione di due nuovi 
                capannoni. Ad oggi, nei 4 capannoni esistenti, vengono allevati a terra circa 70.000 polli 
                in soccida, per circa 6 volte l'anno, per un totale quindi di circa 400.000 capi.
              </p>
            </div>
            <div class="col-sm-3">
              <img src="img/animali7.JPG" class="img-fluid img-thumbnail" alt="panoramica">
            </div>
          </div>

          <div class="row justify-content-md-center" style="margin-top: 1cm;  margin-bottom: 1cm;">
            <div class="col-sm-3" style="margin-right: 0.5cm;">
              <img src="img/animali2.JPG" class="img-fluid img-thumbnail" alt="panoramica">
              <img src="img/animali6.JPG" class="img-fluid img-thumbnail" alt="panoramica" style="margin-top: 0.75cm;">
            </div>
            <div class="col-sm-6" style="margin-top: 0.75cm;">
              <p style="text-align: center">
                Da sempre la nostra azienda è molto attenta al benessere dei propri animali, allevandoli a 
                terra in spazi adeguati, utilizzando mangimi a base di cereali, sani, bilanciati e di alta 
                qualità, provenienti da fonti esterne certificate. Gli stessi dispongono di acqua fresca 
                tutto il giorno e all'interno dei capannoni esistono sensori per il mantenimento di una 
                temperatura e un ricambio d'aria costanti, tali da permettere all'animale le migliori 
                condizioni di crescita, garantite da controlli giornalieri da parte dei nostri operatori e 
                da elevati livelli di biosicurezza. Dal punto di vista sanitario, gli stessi animali vengono 
                poi costantemente seguiti da veterinari specializzati nel settore, a garanzia di salute, 
                qualità e sicurezza alimentare. Questo ci ha permesso di perseguire negli anni una grande 
                esperienza nel settore avicolo, pur rimanendo con orgoglio un'azienda ad esclusiva conduzione 
                familiare, saldamente ancorata ai valori di una volta: il benessere dei propri animali e il 
                rispetto dell'ambiente e della nostra terra. 
              </p>
              <p style="text-align: center">Pratichiamo quotidianamente una gestione 
                responsabile dei rifiuti e possiamo orgogliosamente definirci un'azienda eco sostenibile: 
                i nostri impianti fotovoltaico e a biomasse, ci permettono infatti di coprire il totale 
                fabbisogno energetico dell'azienda, senza immettere nell'atmosfera le sostanze inquinanti che 
                normalmente vengono prodotte dall'utilizzo dei principali combustibili fossili. L'attenzione 
                alla salute dei consumatori e alla sostenibilità ambientale rappresentano, ancora oggi, 
                i pilastri fondamentali della nostra azienda familiare e quello in cui crediamo di più</p>
            </div>
          </div>
@endsection
