...
@section('left_navbar')
                  ...
                  <li class="nav-item">
                    <a class="nav-link current" aria-current="page" href="{{route('coltivazioni')}}">Coltivazioni</a>
                  </li>
                  <li class="nav-item">
...
@section('corpo1')
          <div class="row justify-content-md-center" >
            <div class="col-sm-5 align-self-center" style="background-color: rgb(238, 208, 132);">
              <div id="carouselExampleCaptions" class="carousel slide carousel-fade" data-bs-ride="carousel" style= " margin-left: 0.25cm; margin-right: 0.25cm; margin-top: 0.5cm; margin-bottom: 0.5cm;">
                <div class="carousel-inner">
 
                 <div class="carousel-item active" data-bs-interval="1700">
                   <img src="img/coltivazioni1.JPG" class="img-fluid" alt="territorio" >
                 </div>
 
                 <div class="carousel-item" data-bs-interval="1700">
                   <img src="img/coltivazioni2.JPG" class="img-fluid" alt="coltivazioni" >
                 </div>
 
                 <div class="carousel-item" data-bs-interval="1700">
                   <img src="img/coltivazioni3.JPG" class="img-fluid" alt="allevamenti" >
                 </div>
 
                 <div class="carousel-item" data-bs-interval="1700">
                   <img src="img/coltivazioni4.JPG" class="img-fluid" alt="prodotti" >
                 </div>
 
                 <div class="carousel-item" data-bs-interval="1700">
                   <img src="img/coltivazioni5.JPG" class="img-fluid" alt="contatti" >
                 </div>
            ...
            <div class="col-sm-5 align-self-center" style="margin-top: 0.3cm;">
            <div class="row justify-content-md-center" >
              <p style="text-align:center">
                L'azienda agricola Soleluna coltiva cereali fin dall'inizio della propria attività. Gli 
                stessi sono utilizzati per nutrire i nostri animali (maiali e mucche). Vengono seminati 
                principalmente cereali autunno vernini, come orzo e frumento, ma anche mais nei periodi 
                estivi. Giunti a maturazione vengono raccolti, essiccati, macinati ed utilizzati per 
                produrre i nostri mangimi, il che ci consente di mantenere uno standard qualitativo molto 
                elevato. La parte non utilizzata all'interno dell'azienda viene poi venduta ad altre aziende 
                della zona.
              </p>
              </div>
              <div class="row justify-content-md-center">
              <p style="text-align:center">
                Coltiviamo principalmente a Castelli Calepio nelle aree adiacenti alla nostra 
                cascina (circa 25 ettari complessivi), utilizzando moderne tecniche di coltivazione e 
                limitando l'uso di prodotti nocivi per l'ambiente. L'azienda coltiva i propri vigneti dall'inizio dell'attività, sostituendo nel tempo 
                le vecchie pergole con impianti a spalliera per rendere il lavoro più agevole, rapido e 
                produttivo. L'uva raccolta viene conferita nella sua totalità alla Cantina Sociale 
                Bergamasca, una società cooperativa locale nata nel 1957, anche grazie al contributo di uno 
          ...
          <div class="row justify-content-md-center" style="margin-bottom: 0.5cm;">

            <div class="col-sm-5 align-self-center" style="margin-top: 1.25cm;">
            <div class="row justify-content-md-center">

              <p style="text-align: center"> Le varietà coltivate sono principalmente Merlot e Cabernet per le 
                uve a bacca rossa e Chardonnay e Pinot Grigio per le uve a bacca bianca. Il vino che ne 
                deriva è il locale Valcalepio DOC bianco e rosso, vincitore negli anni di numerosi premi, 
                anche a livello nazionale. Coltiviamo la vite principalmente a Castelli Calepio nelle aree 
                limitrofi all'azienda e nel sotto collina (circa 10 ettari), utilizzando moderne tecniche 
                di coltivazione e limitando l'uso di prodotti nocivi per l'ambiente. La coltivazione del 
                vigneto richiede un'elevata quantità di manodopera durante tutto l'anno, a partire dalle 
                operazioni di potatura fino alla raccolta.
              </p>
              </div>


              <div class="row justify-content-md-center">
              <p style="text-align:center"> La potatura per la vite è fondamentale per 
                assicurare un equilibrio vegeto-produttivo, per la qualità dei frutti e per la salubrità
                della pianta. La raccolta è eseguita ancora prevalentemente in modo manuale. Con il tempo 
                l'azienda si sta però indirizzando verso una meccanizzazione sempre più avanzata, sia per 
                far fronte agli elevati costi e alla mancanza di manodopera, sia per ridurre l'utilizzo 
                di diserbanti chimici nel sottofila, sostituiti dal lavoro di apparecchiature meccaniche.
              </p>
              </div>
            ...
            <div class="col-sm-5 align-self-center" style="background-color: rgb(238, 208, 132); margin-top: 1cm;">
              <div id="carouselExampleCaptions" class="carousel slide carousel-fade" data-bs-ride="carousel" style= " margin-left: 0.25cm; margin-right: 0.25cm; margin-top: 0.5cm; margin-bottom: 0.5cm;">
                <div class="carousel-inner">
 
                 <div class="carousel-item active" data-bs-interval="1700">
                   <img src="img/v1.JPG" class="img-fluid" alt="territorio" >
                 </div>
 
                 <div class="carousel-item" data-bs-interval="1700">
                   <img src="img/v2.JPG" class="img-fluid" alt="coltivazioni" >
                 </div>
 
                 <div class="carousel-item" data-bs-interval="1700">
                   <img src="img/v3.JPG" class="img-fluid" alt="allevamenti" >
                 </div>
 
                 <div class="carousel-item" data-bs-interval="1700">
                   <img src="img/v4.JPG" class="img-fluid" alt="prodotti" >
                 </div>
 
                 <div class="carousel-item" data-bs-interval="1700">
                   <img src="img/v5.JPG" class="img-fluid" alt="contatti" >
                 </div>

                 <div class="carousel-item" data-bs-interval="1700">
                  <img src="img/v6.JPG" class="img-fluid" alt="contatti" >
                </div>

                <div class="carousel-item" data-bs-interval="1700">
                  <img src="img/v7.JPG" class="img-fluid" alt="contatti" >
                </div>

                <div class="carousel-item" data-bs-interval="1700">
                  <img src="img/v8.JPG" class="img-fluid" alt="contatti" >
                </div>

                <div class="carousel-item" data-bs-interval="1700">
                  <img src="img/v9.JPG" class="img-fluid" alt="contatti" >
                </div>
