...
@section('breadcrumb')
            ...
            <!-- <a href="{{route('chisiamo')}}" class="btn btn-testa btn-sm" style="margin-left: 0.2cm;">Torna alla Home</a>
            <a href="{{route('prodotti')}}" class="btn btn-testa btn-sm">Visualizza tutti i prodotti</a>
            <a href="{{route('salamelle')}}" class="btn btn-testa btn-sm" style="margin-left: 16.8cm;">Prodotto precedente</a>
            <a href="{{route('salame')}}" class="btn btn-testa btn-sm">Prodotto successivo</a>     -->       
@endsection
...
@section('corpo1')
          <div class="row justify-content-md-center">
            ...
            <div class="row justify-content-md-center">
              <div class="card" style="font-size: medium; text-align: center; font-weight: bold; margin-bottom: 1cm; margin-top: 0.5cm;">
                <div class="card-body card-intro">
                  Caratteristici delle nostre Feste Natalizie, ma anche adatti per un tradizionale pranzo 
                  della domenica accompagnati da lenticchie o spinaci come tradizione vuole, i nostri 
                  cotechini deliziano ogni anno i palati dei nostri clienti e delle loro famiglie!
                </div>
              </div>
              </div>
              ...
              <div class="row justify-content-md-center">
               <p style="text-align: justify; color: rgb(82, 38, 8);">
                Il nome cotechino deriva dall'utilizzo nella loro produzione delle cosiddette “cotenne”, 
                ovvero le pelli del maiale. Queste, dopo essere state macinate finemente per non risultare 
                fastidiose al palato, vengono salate e speziate dai nostri norcini, mescolate nell'impasto 
                e insaccate in budello naturale. Dopo la legatura a mano, i cotechini andranno appesi nella 
                sala di asciugatura per circa una settimana. 
                </p>    
            </div> 
            </div>
            ...
            <div class="col-sm-4 align-self.center">
                  <img src="img/prodotti/cotechini.jpg" class="img-fluid img-thumbnail" alt="cotechini" style="margin-top: 0.5cm;">
                </div>           
            ...
            <div class="row justify-content-md-center">
              <div class="col-sm-4 align-self-center">
                <img src="img/prodotti/IMG_5019.jpg" class="img-fluid img-thumbnail" alt="salaasciigatura" style="margin-top: 0.75cm;">
              </div>
              <div class="col-sm-4 align-self-center">
                <p style="text-align: justify; color: rgb(82, 38, 8); margin-top: 1.25cm;">
                  Il cotechino è sempre stato riconosciuto come un alimento di grande valore nutrizionale 
                  e gustativo, capace di conquistare il palato dei consumatori di ogni età. 
                  Offre un nutrimento completo ed un gusto irresistibile.
                  ll prodotto va bollito per circa un'ora a partire da acqua fredda e gustato accompagnato 
                  da spinaci, puré o lenticchie, come tradizione vuole.</p>
              </div>
              <div class="col-sm-4 align-self-center">
                <img src="img/prodotti/musetto.jpg" class="img-fluid img-thumbnail" alt="cotechinocucinato" style="margin-top: 0.75cm;">
              </div>
          ...
          <div class="row justify-content-md-center" style="margin-top:1.5cm">
            <div class="col col-lg-3" style="margin-bottom: 2cm;">
              <div class="card text-center h-100">
                <div class="card-body" >
                  <h5 style="font-weight: bold; color: rgb(82, 38, 8)">Prezzo: € 11/kg</h5>
                </div>
