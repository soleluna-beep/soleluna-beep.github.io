...
@section('breadcrumb')
            ...
            <a href="{{route('coppaepancetta')}}" class="btn btn-testa btn-sm" style="margin-left: 16.8cm;">Prodotto precedente</a>
            <a href="{{route('cotechini')}}"class="btn btn-testa btn-sm">Prodotto successivo</a>  -->          
@endsection
          ...
          <div class="row justify-content-md-center">
            ...
            <div class="row justify-content-md-center">
              <div class="card" style="font-size: medium; text-align: center; font-weight: bold; margin-bottom: 1cm; margin-top: 0.5cm;">
                <div class="card-body card-intro" style="text-align: center;">
                Voglia di grigliata? Ci pensa l'azienda agricola Soleluna! 
                </div>
              </div>
              </div>
              ...
              <div class="row justify-content-md-center">
               <p style="text-align: justify; color: rgb(82, 38, 8);">
                Le nostre salamelle fresche sono realizzate con tagli di spalla dei nostri maiali, 
                a cui va aggiunta una piccola quantità di carne di manzo, anch'essa proveniente dal 
                nostro allevamento. Salate e speziate secondo le nostre antiche ricette, sono 
                consumabili fin da subito. Non esitate a provarle, arricchiranno il vostro barbecue 
                con sapori sfiziosi e non potrete più farne a meno: una tira l'altra! 
                </p>    
            </div>
            </div> 
            ...
            <div class="col-sm-4">
                  <img src="img/prodotti/salamelle.jpg" class="img-fluid img-thumbnail" alt="salamelle" style="margin-top: 0.5cm;">
                </div>           
      ...
      <div class="row justify-content-md-center" style="margin-top: 1.5cm">
        <div class="col col-lg-3" style="margin-bottom: 2cm;">
          <div class="card text-center h-100">
            <div class="card-body" >
              <h5 style="font-weight: bold; color: rgb(82, 38, 8)">Prezzo: € 12/kg</h5>
            </div>
