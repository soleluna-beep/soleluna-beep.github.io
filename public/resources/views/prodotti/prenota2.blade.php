...
<div class="bg-image" style="background-image: url('../img/IMG_5023(1).jpg'); background-size: cover; height: 100vh">
    <div class="row justify-content-md-center">
        <div class="col-sm-7" style="background-color: rgb(235, 215, 106); margin-top: 4.25cm; opacity: 0.9">
          ...
          <div class="col-sm-2" style="text-align: center; margin-top: 0.25cm;">
            ...
            <a href="{{ route('acquistaprodotti.index') }}" class="btn btn-testa" style="margin-top:1.25cm; margin-left:7cm; 
            margin-right: 5cm"> Torna alla lista prodotti</a>
            </form> 
        </div>
    </div>
</div>
