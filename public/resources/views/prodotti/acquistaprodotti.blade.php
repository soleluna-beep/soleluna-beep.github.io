...
@section('left_navbar')
                  ...
                  <li class="nav-item dropdown current">
                    ...
                    <ul class="dropdown-menu">
                      ...
                      <li class="current"><a class="dropdown-item" href="{{route('acquistaprodotti.index')}}">Prenota Prodotti</a></li>
                    </ul>
                  </li>
                  <li class="nav-item">
...
@section('breadcrumb')
<a href="{{route('prodotti')}}" class="btn btn-testa btn-sm" > 
...
@section('corpo1')
          <p style="text-align: center;">I nostri prodotti possono essere <strong>prenotati telefonicamente 
            o per e-mail </strong>e <strong>ritirati esclusivamente in loco</strong>. Vi ricordiamo che i prodotti freschi sono già disponibili 
          pochi giorni dopo la produzione, mentre per quelli stagionati l'attesa per il ritiro varia in
          base alla stagionatura, che va dai due ai sei/otto mesi. <strong>Il ritiro può essere effettuato
          solamente negli orari di apertura (Lun-Ven: 8-12/14-18, Sab: 9-12).
          </strong> Per qualsiasi richiesta particolare non esitate a contattarci.
          </p>

        <div class="row justify-content-md-center" style="margin-bottom: 0.5cm;">

          <div class="col col-sm-4" style="margin-top:0.5cm">
              <div class="card text-center h-100">
                <img src="img/prodotti/salame.jpg" class="card-img-top" alt="immagine">
                <div class="card-body">
                  <h5 class="card-title" style="margin-top: 0.25cm; font-style: italic; color: rgb(82, 38, 8)">Salame</h5>
                  <p style="margin-top: 0.5cm; font-family: 'Lucida Sans', 'Lucida Sans Regular', 'Lucida Grande', 'Lucida Sans Unicode', Geneva, Verdana, sans-serif; color: rgb(82, 38, 8); text-align: center;"> Prezzo: 24 €/kg</p>                  
                  <h6><span class="badge" style="color: rgb(82, 38, 8); background-color: gold">Disponibile</span></h6>
                  <!-- <h6><span class="badge" style="color: white; background-color: red">Non Disponibile</span></h6> -->
                </div>
                <div class="card-footer text-body-secondary" style="background-color: rgb(238, 208, 132);">  
                <a href="{{route('prenota')}}" class="btn btn-sm btn-light btn-prodotti" style="font-weight: yellow;">
                ...
                <!-- <div class="card-footer text-body-secondary" style="background-color: rgb(238, 208, 132);">
                <a href="" class="btn btn-light btn-testa disabled btn-sm" style="font-weight: yellow;" aria-disabled="true">
                    Prenotazioni chiuse</a>
                    </div> -->
              </div>
              </div>
              ...
              <div class="col col-sm-4" style="margin-top:0.5cm">
              <div class="card text-center h-100">
                <img src="img/prodotti/cacciatore.jpg" class="card-img-top" alt="immagine">
                <div class="card-body">
                  <h5 class="card-title" style="margin-top: 0.25cm; font-style: italic; color: rgb(82, 38, 8)">Cacciatore</h5>
                  <p style="margin-top: 0.5cm; font-family: 'Lucida Sans', 'Lucida Sans Regular', 'Lucida Grande', 'Lucida Sans Unicode', Geneva, Verdana, sans-serif; color: rgb(82, 38, 8); text-align: center;"> Prezzo: 22 €/kg</p>                  
                  <h6><span class="badge" style="color: rgb(82, 38, 8); background-color: gold">Disponibile</span></h6>
                  <!-- <h6><span class="badge" style="color: white; background-color: red">Non Disponibile</span></h6> -->
                </div>
                <div class="card-footer text-body-secondary" style="background-color: rgb(238, 208, 132);">  
              ...
              <div class="col col-sm-4" style="margin-top:0.5cm">
              <div class="card text-center h-100">
                <img src="img/prodotti/pancetta.jpg" class="card-img-top" alt="immagine">
                <div class="card-body">
                  <h5 class="card-title" style="margin-top: 0.25cm; font-style: italic; color: rgb(82, 38, 8)">Pancetta</h5>
                  <p style="margin-top: 0.5cm; font-family: 'Lucida Sans', 'Lucida Sans Regular', 'Lucida Grande', 'Lucida Sans Unicode', Geneva, Verdana, sans-serif; color: rgb(82, 38, 8); text-align: center;"> Prezzo: 22 €/kg</p>                  
                  <h6><span class="badge" style="color: rgb(82, 38, 8); background-color: gold">Disponibile</span></h6>
                  <!-- <h6><span class="badge" style="color: white; background-color: red">Non Disponibile</span></h6> -->
                </div>
    ...
    <div class="col col-sm-4" style="margin-top:0.5cm">
    <div class="card text-center h-100">
      <img src="img/prodotti/coppa .jpg" class="card-img-top" alt="immagine">
      <div class="card-body">
        <h5 class="card-title" style="margin-top: 0.25cm; font-style: italic; color: rgb(82, 38, 8)">Coppa</h5>
        <p style="margin-top: 0.5cm; font-family: 'Lucida Sans', 'Lucida Sans Regular', 'Lucida Grande', 'Lucida Sans Unicode', Geneva, Verdana, sans-serif; color: rgb(82, 38, 8); text-align: center;"> Prezzo: 22 €/kg</p>                  
        <h6><span class="badge" style="color: rgb(82, 38, 8); background-color: gold">Disponibile</span></h6>
        <!-- <h6><span class="badge" style="color: white; background-color: red">Non Disponibile</span></h6> -->
      </div>
    ...
    <div class="col col-sm-4" style="margin-top:0.5cm">
    <div class="card text-center h-100">
      <img src="img/prodotti/salamelle.jpg" class="card-img-top" alt="immagine">
      <div class="card-body">
        <h5 class="card-title" style="margin-top: 0.25cm; font-style: italic; color: rgb(82, 38, 8)">Salamelle</h5>
        <p style="margin-top: 0.5cm; font-family: 'Lucida Sans', 'Lucida Sans Regular', 'Lucida Grande', 'Lucida Sans Unicode', Geneva, Verdana, sans-serif; color: rgb(82, 38, 8); text-align: center;"> Prezzo: 12 €/kg</p>                  
        <h6><span class="badge" style="color: rgb(82, 38, 8); background-color: gold">Disponibile</span></h6>
        <!-- <h6><span class="badge" style="color: white; background-color: red">Non Disponibile</span></h6> -->
      </div>
      <div class="card-footer text-body-secondary" style="background-color: rgb(238, 208, 132);">  
    ...
    <div class="col col-sm-4" style="margin-top:0.5cm">
    <div class="card text-center h-100">
      <img src="img/prodotti/cotechini.jpg" class="card-img-top" alt="immagine">
      <div class="card-body">
        <h5 class="card-title" style="margin-top: 0.25cm; font-style: italic; color: rgb(82, 38, 8)">Cotechini</h5>
        <p style="margin-top: 0.5cm; font-family: 'Lucida Sans', 'Lucida Sans Regular', 'Lucida Grande', 'Lucida Sans Unicode', Geneva, Verdana, sans-serif; color: rgb(82, 38, 8); text-align: center;"> Prezzo: 11 €/kg</p>                  
        <h6><span class="badge" style="color: rgb(82, 38, 8); background-color: gold">Disponibile</span></h6>
        <!-- <h6><span class="badge" style="color: white; background-color: red">Non Disponibile</span></h6> -->
      </div>
      <div class="card-footer text-body-secondary" style="background-color: rgb(238, 208, 132);">  
      ...
      <div class="row justify-content-md-center" style="margin-top: 2.5cm;">
            <div class="col-sm-3">
            <a href="{{ route('acquistaprodotti.create') }}" class="btn btn-prodotti">Inserisci un nuovo prodotto acquistabile</a>
          </div>
      </div>
      @endif -->
