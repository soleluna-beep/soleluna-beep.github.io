...
@section('left_navbar')
     ...
     @section('breadcrumb')
            ...
            <a href="{{route('salame')}}" class="btn btn-testa btn-sm" >Prodotto precedente</a>
            <a href="{{route('coppaepancetta')}}" class="btn btn-testa btn-sm">Prodotto successivo</a>  -->      
    @endsection
    ...
    @section('corpo1')
          <div class="row justify-content-md-center">
            ...
            <div class="row justify-content-md-center">
              <div class="card" style="font-size: medium; text-align: center; font-weight: bold; margin-bottom: 0.75cm;">
                <div class="card-body card-intro">
                  Così denominato perché utilizzato dai cacciatori come spuntino durante le lunghe giornate 
                  di caccia, questo insaccato è ancora oggi il protagonista di tanti aperitivi accompagnati 
                  da un buon bicchiere di vino! Nonostante le sue piccole dimensioni, ha sempre dato grandi 
                  soddisfazioni ai palati dei nostri clienti
                </div>
              </div>
              </div>
              ...
              <div class="row justify-content-md-center">
               <p style="text-align: justify; color: rgb(82, 38, 8); ">
                Il cacciatore è un insaccato prodotto utilizzando principalmente tagli di spalla del maiale, 
                a cui va aggiunta una piccola percentuale quantità di carne di manzo, anch'essa proveniente 
                dal nostro allevamento. Salato e speziato secondo le nostre antiche ricette, viene legato a mano secondo 
                l'antica tradizione, per poi essere appeso sui cosiddetti “cerchi”, che altro non sono 
                che veri e propri vecchi cerchi di ruote di biciclette. 
                </p>    
            </div> 
            </div>
            ...
            <div class="col-sm-4 align-self-center">
                  <img src="img/prodotti/cacciatore.jpg" class="img-fluid img-thumbnail" alt="cacciatore">
                </div>           
            ...
            <div class="row justify-content-md-center">
              <div class="col-sm-4 align-self-center">
                <img src="img/prodotti/IMG_5023(1).jpg" class="img-fluid img-thumbnail" alt="cacciatoreappeso" style="margin-top: 0.75cm;">
              </div>
              <div class="col-sm-4 align-self-center">
                <p style="text-align: justify; color: rgb(82, 38, 8); margin-top: 1cm;">
                  Asciugato per una settimana, 
                  viene fatto stagionare per circa un mese, affinché questo piccolo insaccato possa 
                  deliziare i palati più esigenti con i suoi grandi sapori ed il suo inconfondibile 
                  profumo… nella botte piccola c'è il vino buono!</p>
              </div>
              <div class="col-sm-4 align-self-center">
                <img src="img/prodotti/IMG_5017.jpg" class="img-fluid img-thumbnail" alt="cerchi" style="margin-top: 0.75cm;">
              </div>
          ...
          <div class="row justify-content-md-center" style="margin-top: 1.5cm">
            <div class="col col-lg-3" style="margin-bottom: 2cm;">
              <div class="card text-center h-100">
                <div class="card-body" >
                  <h5 style="font-weight: bold; color: rgb(82, 38, 8)">Prezzo: € 22/kg</h5>
                </div>
