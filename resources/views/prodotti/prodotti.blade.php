...
@section('left_navbar')
                  ...
                  <li class="nav-item">
                    <a class="nav-link" aria-current="page" href="{{route('territorio')}}">Il Territorio</a>
                  </li>
                  <li class="nav-item">
                  ...
                  <li class="nav-item dropdown current">
                    ...
                    <ul class="dropdown-menu">
                      <li class="current"><a class="dropdown-item" href="{{route('prodotti')}}">I Nostri Prodotti</a></li>
...
@section('breadcrumb')
            ...
            <!-- <a href="{{route('acquistaprodotti.index')}}" class="btn btn-testa btn-sm" style="margin-left: 25.9cm;">Prenota i nostri prodotti</a> -->
@endsection
...
@section('corpo1')
          ...
          <div class="col-sm-4 align-self-center" style= "background-color: rgb(238, 208, 132);">  
                <div id="carouselExampleCaptions" class="carousel slide carousel-fade" data-bs-ride="carousel" style= " margin-left: 0.25cm; margin-right: 0.25cm; margin-top: 0.75cm; margin-bottom: 0.75cm;">
                  <div class="carousel-inner">
                   ...
                   <div class="carousel-item active" data-bs-interval="1700">
                     <img src="img/prodotti1.jpg" class="img-fluid" alt="territorio" >
                   </div>
   
                   <div class="carousel-item" data-bs-interval="1700">
                     <img src="img/prodotti2.jpg" class="img-fluid" alt="coltivazioni" >
                   </div>
   
                   <div class="carousel-item" data-bs-interval="1700">
                     <img src="img/prodotti3.jpg" class="img-fluid" alt="allevamenti" >
                   </div>
   
                   <div class="carousel-item" data-bs-interval="1700">
                     <img src="img/prodotti4.jpg" class="img-fluid" alt="prodotti" >
                   </div>
   
                   <div class="carousel-item" data-bs-interval="1700">
                     <img src="img/prodotti5.jpg" class="img-fluid" alt="contatti" >
                   </div>
              ...
              <div class="row justify-content-md-center" style="margin-top: 0.25cm">
                      <p style="margin-top:0.1cm; text-align: center">I nostri salumi vengono prodotti con le carni dei suini e dei bovini allevati 
                        e cresciuti nella nostra cascina, che nutriamo esclusivamente con i foraggi e i 
                        cereali da noi coltivati. Da sempre ne seguiamo la macellazione, la selezione e 
                        la lavorazione delle carni migliori, per ottenere prodotti artigianali di qualità 
                        superiore, privi di conservanti, coloranti, additivi e prodotti chimici. Solo carne 
                        di maiale, bovino e spezie naturali, secondo le antiche ricette dei nostri esperti 
                        norcini. Ancora oggi li insacchiamo in budello naturale e li leghiamo interamente a 
                        mano con lo spago, rispettando ogni fase di preparazione come da antica tradizione. 
                        Per questo i nostri salumi sono uno diverso dall'altro, perché ogni processo è 
                        eseguito ancora manualmente, come una volta. La stagionatura naturale ha poi i 
                        suoi tempi, che devono essere rispettati affinché i salumi diventino davvero buoni 
                        e possano veramente distinguersi per gusto e profumo. Non bisogna avere fretta, ma 
                        aspettare che la cantina della cascina e il tempo facciano il loro lavoro. Produrre 
                        dei salumi in modo artigianale richiede sicuramente dei tempi più lunghi e laboriosi,
                         con la certezza però di ottenere prodotti genuini e dal sapore unico e 
                         inconfondibile, proprio come una volta.
...
@section('corpo2')
    <p style="text-align: center;">Insaccati <strong>prenotabili da ottobre a marzo/aprile</strong> e disponibili per la <strong>vendita da dicembre a maggio/giugno.</strong></p>
      
    <div class="row justify-content-md-center" style="background-color: rgb(238, 208, 132); margin-top: 0.75cm;">
        <div class="col-sm-3 align-self-center" style="margin-top: 0.5cm; margin-bottom: 0.5cm;"> 
          <img src="img/prodotti/salame.jpg" class="img-fluid" alt="salame"> 
        </div> 
        <div class="col-lg-3 align-self-center" >
        <div class="row justify-content-md-center">
        <h1 style="color: rgb(82, 38, 8); text-align: center;">Salame Bergamasco</h1>
        </div>
        <div class="row justify-content-md-center">

        <div class="d-grid gap-2 col-6 mx-auto">
          <a href="{{route('salame')}}" class="btn btn-light btn-prodotti" style="margin-top: 1cm; margin-bottom: 1cm; font-weight: bold;">Scopri di più!</a>
        </div>
        </div>
        </div>
    </div> 

      <div class="row justify-content-md-center" style="background-color: khaki;">
      <div class="col-sm-3 align-self-center" style="margin-top: 0.5cm; margin-bottom: 0.5cm;"> 
          <img src="img/prodotti/cacciatore.jpg" class="img-fluid" alt="cacciatore"> 
        </div> 
        <div class="col-lg-3 align-self-center" >
        <div class="row justify-content-md-center">
        <h1 style="color: rgb(82, 38, 8); text-align: center;">Cacciatore</h1>
        </div>
        <div class="row justify-content-md-center">

        <div class="d-grid gap-2 col-6 mx-auto">
          <a href="{{route('cacciatore')}}" class="btn btn-light btn-prodotti" style="margin-top: 1cm; margin-bottom: 1cm; font-weight: bold;">Scopri di più!</a>
        </div>
        </div>
        </div>
      </div>

      <div class="row justify-content-md-center" style="background-color: rgb(238, 208, 132);">
        <div class="col-sm-3 align-self-center" style="margin-top: 0.5cm; margin-bottom: 0.5cm;"> 
          <img src="img/prodotti/coppa e pancetta.jpg" class="img-fluid" alt="coppaepancetta"> 
        </div> 
        <div class="col-lg-3 align-self-center" >
        <div class="row justify-content-md-center">
        <h1 style="color: rgb(82, 38, 8); text-align: center;">Coppa e Pancetta</h1>
        </div>
        <div class="row justify-content-md-center">

        <div class="d-grid gap-2 col-6 mx-auto">
          <a href="{{route('coppaepancetta')}}" class="btn btn-light btn-prodotti" style="margin-top: 1cm; margin-bottom: 1cm; font-weight: bold;">Scopri di più!</a>
      </div>
...
@section('corpo3')
 <p style="text-align: center; margin-top: 0.75cm;">Prodotti <strong>prenotabili e disponibili per la vendita da ottobre a marzo/aprile</strong></p>

      <div class="row justify-content-md-center" style="background-color: rgb(238, 208, 132);">
        <div class="col-sm-3 align-self-center" style="margin-top: 0.5cm; margin-bottom: 0.5cm;"> 
          <img src="img/prodotti/salamelle.jpg" class="img-fluid" alt="salamelle"> 
        </div> 
        <div class="col-lg-3 align-self-center" >
        <div class="row justify-content-md-center">
        <h1 style="color: rgb(82, 38, 8); text-align: center;">Salamelle</h1>
        </div>
        <div class="row justify-content-md-center">
        <div class="d-grid gap-2 col-6 mx-auto">
          <a href="{{route('salamelle')}}" class="btn btn-light btn-prodotti" style="margin-top: 1cm; margin-bottom: 1cm; font-weight: bold;">Scopri di più!</a>
        </div>
        </div>
        </div>
    </div> 
    ...
    <div class="row justify-content-md-center" style="background-color:khaki">
        <div class="col-sm-3 align-self-center" style="margin-top: 0.5cm; margin-bottom: 0.5cm;"> 
          <img src="img/prodotti/cotechini.jpg" class="img-fluid" alt="cotechini"> 
        </div> 
        <div class="col-lg-3 align-self-center" >
        <div class="row justify-content-md-center">
        <h1 style="color: rgb(82, 38, 8); text-align: center;">Cotechini</h1>
        </div>
        <div class="row justify-content-md-center">
        <div class="d-grid gap-2 col-6 mx-auto">
          <a href="{{route('cotechini')}}" class="btn btn-light btn-prodotti" style="margin-top: 1cm; margin-bottom: 1cm; font-weight: bold;">Scopri di più!</a>
        </div>
        </div>
        </div>
    </div> 
...
<div class="row justify-content-md-center">
        ...
        <div class="col-sm-2" style="margin-top: 1.5cm;">
          <p style="font-size: small; font-weight: bolder; margin-left: 0.25cm;">I Nostri Prodotti</p>
          <div class="btn-group-vertical" role="group" aria-label="Vertical button group">
