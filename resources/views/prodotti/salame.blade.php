...
@section('breadcrumb')
            ...
            </svg> Torna ai prodotti</a>
            <!--<a href="{{route('chisiamo')}}" class="btn btn-testa btn-sm" >Torna alla Home</a> -->
            <!-- <a href="{{route('prodotti')}}" class="btn btn-testa btn-sm">Visualizza tutti i prodotti</a>
            <a href="{{route('cotechini')}}" class="btn btn-testa btn-sm" style="margin-left: 16.8cm;">Prodotto precedente</a>
            <a href="{{route('cacciatore')}}" class="btn btn-testa btn-sm">Prodotto successivo</a> -->           
@endsection
...
@section('corpo1')
        <div class="row justify-content-md-center">
          ...
          <div class="row justify-content-md-center">
            <div class="card" style="font-size: medium; text-align: center; font-weight: bold; margin-bottom: 0.75cm;">
              <div class="card-body card-intro">
              “Ol salam dela bergamasca”, 
              l'insaccato più conosciuto e consumato all'interno della nostra 
              provincia, oltre che il più apprezzato tra quelli prodotti dall'azienda Soleluna.
              </div>
            </div>
            </div>
            
            <div class="row justify-content-md-center">
             <p style="text-align: justify; color: rgb(82, 38, 8);">
              Il salame bergamasco è un prodotto tipico realizzato utilizzando le parti più 
              pregiate del maiale, allevato e macellato direttamente da noi, con l'aggiunta solo 
              di sale e spezie. Alla fase di produzione, dove il salame viene insaccato in budello naturale 
              e legato rigorosamente a mano come una volta, segue un'asciugatura di circa una settimana 
              in ambiente controllato e successiva stagionatura di almeno due mesi all'interno della vecchia 
              cantina sotterranea della cascina. 
              </p>    
          </div> 
          </div> 
          ...
          <div class="col-sm-4 align-self-center">
                <img src="img/prodotti/salame.jpg" class="img-fluid img-thumbnail" alt="salame" style="">
              </div>           
          ...
          <div class="row justify-content-md-center">
            <div class="col-sm-4 align-self-center">
              <img src="img/prodotti/IMG_4955(1).jpg" class="img-fluid img-thumbnail" alt="salameappeso" style="margin-top: 0.75cm;">
            </div>
            <div class="col-sm-4 align-self-center">
              <p style="text-align: justify; color: rgb(82, 38, 8); margin-top: 0.75cm">
                Le condizioni di temperatura e umidità costanti e 
                controllate sono uno dei segreti per la stagionatura ottimale del salame e per la formazione 
                delle tipiche muffe benefiche sulla sua superficie. Ogni pezzo è frutto di una lavorazione 
                artigianale che rispetta la tradizione, garantendone nel contempo la qualità, la genuinità, 
                ma soprattutto il profumo ed il sapore inconfondibili, che ne fanno da sempre il nostro 
                prodotto di punta.</p>
            </div>
            <div class="col-sm-4 align-self-center">
              <img src="img/prodotti/f06e9480-0fd8-4483-849d-cefcf1a225e1.jpg" class="img-fluid img-thumbnail" alt="salametagliato" style="margin-top: 0.75cm;">
            </div>
...
@section('corpo2')
        <div class="row justify-content-md-center" style="margin-top: 1.5cm">
          <div class="col col-lg-3" style="margin-bottom: 2cm;">
            <div class="card text-center h-100">
              <div class="card-body" >
                <h5 style="font-weight: bold; color: rgb(82, 38, 8)">Prezzo: € 24/kg</h5>
              </div>
              <div class="card-footer text-body-secondary" style="background-color: rgb(238, 211, 142);">
                <a href="{{route('acquistaprodotti.index')}}" class="btn btn-light btn-prodotti" style="font-weight: bold;"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-cart4" viewBox="0 0 16 16">
