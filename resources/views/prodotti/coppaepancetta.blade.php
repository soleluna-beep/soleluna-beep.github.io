...
@section('breadcrumb')
           <a href="{{route('prodotti')}}" class="btn btn-testa btn-sm" > 
            ...
            <a href="{{route('cacciatore')}}" class="btn btn-testa btn-sm" style="margin-left: 16.8cm;">Prodotto precedente</a>
            <a href="{{route('salamelle')}}" class="btn btn-testa btn-sm">Prodotto successivo</a>  -->           
@endsection
...
@section('corpo1')
            <div class="row justify-content-md-center">
              ...
              <div class="row justify-content-md-center">
                <div class="card" style="font-size: medium; text-align: center; font-weight: bold; margin-bottom: 1cm; margin-top: 0.5cm;">
                  <div class="card-body card-intro">
                    Ideali per completare un tagliere di salumi bergamaschi sfizioso, 
                    coppa e pancetta sono due insaccati molto apprezzati dai nostri consumatori, 
                    in particolare durante primavera ed estate, dove all'interno di un buon panino, 
                    rendono il pic-nic ancora più gustoso!
                  </div>
                </div>
                </div>
                ...
                <div class="row justify-content-md-center">
                 <p style="text-align: justify; color: rgb(82, 38, 8);">
                  Coppa e Pancetta vengono realizzate salando e speziando i due rispettivi tagli di carne
                  del maiale, insaccate in un budello naturale, asciugate e stagionate per un periodo di 
                  tempo piuttosto lungo, circa 6-8 mesi. Si dice che l'attesa aumenti il desiderio… 
                  provare per credere!
                  </p>    
              </div>
              </div> 
              ...
              <div class="col-sm-4">
                    <img src="img/prodotti/coppa e pancetta.jpg" class="img-fluid img-thumbnail" alt="coppaepancetta" style="margin-top: 0.5cm;">
                  </div>           
