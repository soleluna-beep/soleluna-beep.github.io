...
@section('left_navbar')
                  ...
                  <li class="nav-item">
                    <a class="nav-link current" aria-current="page" href="{{route('diconodinoi.index')}}">Dicono di noi</a>
                  </li>
                  <li class="nav-item">
...
@section('corpo1')
          <div class="row justify-content-md-center" style="margin-bottom: 0.5cm; margin-top: 1cm">
            <div class="col-sm-4" style="background-color: rgb(235, 215, 106)">
              <p style="text-align: center; margin-bottom: 0.25cm; margin-top: 0.25cm;">Alma Licini</p>

              <p style="text-align: center; margin-bottom: 0.25cm; margin-top: 0.25cm;">
              ...
              <blockquote class="blockquote" style="margin-top: 0.25cm;">
                <p style="font-style: italic; font-weight: bold; text-align: center;">
                  Ogni volta che mangio il vostro salame dico: "Ho fatto una cena da re!". Ve lo consiglio, non rimarrete delusi!
                </p>
              </blockquote>
          ...
          <div class="row justify-content-md-center" style="margin-bottom: 0.5cm">
            <div class="col-sm-4" style="background-color: rgb(235, 215, 106)">
              <p style="text-align: center; margin-bottom: 0.25cm; margin-top: 0.25cm;">Luca Begni</p>
            ...
            <p style="text-align: center; margin-bottom: 0.25cm; margin-top: 0.25cm;">
              ...
              <blockquote class="blockquote" style="margin-top: 0.25cm;">
                <p style="font-style: italic; font-weight: bold; text-align: center;">
                 Uno dei salami più buoni e genuini in circolazione! La famiglia Pagani è una garanzia!
                </p>
              </blockquote>
          ...
          <div class="row justify-content-md-center" style="margin-bottom: 0.5cm">
            <div class="col-sm-4" style="background-color: rgb(235, 215, 106)">
              <p style="text-align: center; margin-bottom: 0.25cm; margin-top: 0.25cm;">Marco Carrara</p>
              ...
              <blockquote class="blockquote" style="margin-top: 0.5cm;">
                <p style="font-style: italic; font-weight: bold; text-align: center;">
                  Ottimi prodotti! Lo consiglio!
                </p>
              </blockquote>
          ...
          <div class="row justify-content-md-center" style="margin-bottom: 0.25cm">
            <div class="col-sm-4" style="background-color: rgb(235, 215, 106)">
              <p style="text-align: center; margin-bottom: 0.25cm; margin-top: 0.25cm;">Francesca Cucchi</p>
              ...
              <blockquote class="blockquote" style="margin-top: 0.25cm;">
                <p style="font-style: italic; font-weight: bold; text-align: center;">
                  Consiglio assolutamente l'Azienda Agricola Fratelli Pagani. 
                  Prodotti di altissima qualità, provate i loro salami, sono davvero 
                  i più buoni che io e la mia famiglia abbiamo mai mangiato!
                </p>
              </blockquote>
